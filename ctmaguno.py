...
database_list = [
    ("data/trajectory_dataset_ct_turn_1deg_fixed_std_0m_dt_1.npz", "std = 0 m (Noiseless)", 6),
    ("data/trajectory_dataset_ct_turn_1deg_fixed_std_5m_dt_1.npz", "std = 5 m", 4),
    ("data/trajectory_dataset_ct_turn_1deg_fixed_std_10m_dt_1.npz", "std = 10 m", 4),
]
